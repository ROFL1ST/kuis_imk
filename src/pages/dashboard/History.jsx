          ...
          <div className="flex gap-3">
             <div className="bg-white px-4 py-2 rounded-xl border border-slate-200 shadow-sm flex items-center gap-3">
                ...
                <div>
                   ...
                   <p className="text-sm font-bold text-slate-800">{histories.length} Kuis</p>
                </div>
             </div>
             <div className="bg-white px-4 py-2 rounded-xl border border-slate-200 shadow-sm flex items-center gap-3">
                ...
                <div>
                   ...
                   <p className="text-sm font-bold text-slate-800">{averageScore}</p>
                </div>
             </div>
          </div>
        )}
        ...
        <div className="grid gap-4">
          {histories.map((item) => {
             ...
             return (
              ...
              >
                {/* Visual Tambahan untuk Duel: Watermark & Status Bar */}
                {isDuel ? (
                  <>
                ...
                <div className="flex items-start gap-4 pl-2 w-full sm:w-auto z-10">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <h3 className={`text-lg font-bold transition-colors line-clamp-1 ${isDuel ? 'text-slate-900' : 'text-slate-800 group-hover:text-indigo-600'}`}>
                          {cleanTitle}
                        </h3>
                    </div>
                ...
                <div className="flex items-center self-end sm:self-center z-10">
                   <span className={`text-xs font-bold mr-2 transition-colors uppercase tracking-wide hidden sm:block ${isDuel ? 'text-orange-400 group-hover:text-orange-600' : 'text-slate-400 group-hover:text-indigo-600'}`}>
                      Review
                   </span>
