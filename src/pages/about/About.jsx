  ...
  return (
    ...
    >
      ...
      <div className="text-center py-16">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
            QuizApp adalah platform gamifikasi edukasi yang dirancang untuk menguji pengetahuanmu, menantang teman, dan melacak perkembangan belajarmu dengan cara yang menyenangkan.
          </p>
        </motion.div>
      </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1">
            ...
            <div className="space-y-4 text-slate-600 leading-relaxed">
              <p>
                Kami percaya bahwa belajar tidak harus membosankan. Dengan menggabungkan elemen permainan (gamifikasi) ke dalam proses pembelajaran, kami ingin menciptakan ekosistem di mana pengguna termotivasi untuk terus mencari ilmu.
              </p>
              <p>
                Aplikasi ini dibangun sebagai proyek untuk mendemonstrasikan integrasi teknologi web modern, performa tinggi, dan pengalaman pengguna (UX) yang intuitif.
              </p>
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <div className="flex items-center gap-2 text-sm font-bold text-slate-700 bg-slate-50 px-4 py-2 rounded-lg border border-slate-200">
                <CheckCircle size={16} className="text-green-500" /> Free to Play
              </div>
              <div className="flex items-center gap-2 text-sm font-bold text-slate-700 bg-slate-50 px-4 py-2 rounded-lg border border-slate-200">
                <CheckCircle size={16} className="text-green-500" /> Real-time
              </div>
              <div className="flex items-center gap-2 text-sm font-bold text-slate-700 bg-slate-50 px-4 py-2 rounded-lg border border-slate-200">
                <CheckCircle size={16} className="text-green-500" /> Mobile Friendly
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 w-full flex justify-center">
             <div className="grid grid-cols-2 gap-4 w-full max-w-sm">
                ...
                <TechBadge label="Tailwind" color="text-teal-500" bg="bg-teal-50" />
                <TechBadge label="PostgreSQL" color="text-indigo-600" bg="bg-indigo-50" />
             </div>
          </div>
        </div>
      </motion.div>
      ...
      <div className="text-center border-t border-slate-200 pt-12">
        <h3 className="text-xl font-bold text-slate-800 mb-2">Ingin berkontribusi?</h3>
        <p className="text-slate-500 mb-6">Proyek ini bersifat Open Source. Bergabunglah dengan kami!</p>
        
        <div className="flex justify-center gap-4 mb-12">
          <a href="https://github.com/ROFL1ST/kuis_imk" className="p-3 bg-slate-800 text-white rounded-full hover:bg-slate-900 transition hover:scale-110">
            <Github size={20} />
          </a>
          <a href="" className="p-3 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 transition hover:scale-110">
            <Globe size={20} />
          </a>
        </div>

        <p className="text-slate-400 text-sm flex items-center justify-center gap-1">
          Dibuat dengan <Heart size={14} className="text-red-500 fill-red-500 animate-pulse" /> oleh Tim QuizApp
        </p>
      </div>
    </motion.div>
  );
...
const FeatureCard = ({ icon, title, desc, color, delay }) => (
  ...
  >
    <div className={`w-12 h-12 ${color} rounded-xl flex items-center justify-center mb-4 shadow-md rotate-3`}>
      {icon}
    </div>
...
const TechBadge = ({ label, color, bg }) => (
  <div className={`flex items-center justify-center gap-2 p-4 rounded-xl ${bg} border border-slate-100 font-bold ${color}`}>
    <Code size={18} /> {label}
  </div>
);
