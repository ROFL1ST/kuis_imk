        ...
        {open && (
          <div className="sm:hidden absolute top-16 left-0 w-full bg-white border-b border-slate-200 shadow-xl animate-slideDown z-40 flex flex-col max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-4 pt-4 pb-2">
              <div className="grid grid-cols-2 gap-3">
                <div className="flex items-center justify-center gap-2 bg-orange-50 text-orange-700 px-3 py-3 rounded-xl border border-orange-100 font-bold text-sm shadow-sm">
                  <Flame size={18} fill="currentColor" /> {user?.streak_count || 0} Streak
                </div>
            ...
            <div className="px-4 py-2 flex flex-col gap-1">
                <Link to="/" onClick={() => setOpen(false)} className="flex items-center gap-3 px-4 py-3.5 text-slate-600 hover:bg-slate-50 hover:text-indigo-600 rounded-xl transition font-medium">
                  <LayoutDashboard size={20} /> Topik Kuis
                </Link>
                <Link to="/challenges" onClick={() => setOpen(false)} className="flex items-center gap-3 px-4 py-3.5 text-slate-600 hover:bg-slate-50 hover:text-indigo-600 rounded-xl transition font-medium">
                  <Swords size={20} /> Arena Duel
                </Link>
                <Link to="/friends" onClick={() => setOpen(false)} className="flex items-center gap-3 px-4 py-3.5 text-slate-600 hover:bg-slate-50 hover:text-indigo-600 rounded-xl transition font-medium">
                  <Users size={20} /> Teman
                </Link>
