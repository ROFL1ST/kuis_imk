...
const StreakSuccessModal = ({
  ...
  const title =
    type === "recovered"
      ? t("modals.streakRecoveredTitle")
      : t("modals.streakExtendedTitle");
  const message =
    type === "recovered"
      ? t("modals.streakRecoveredDesc")
      : t("modals.streakExtendedDesc");
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-4 right-4 text-slate-400 hover:text-slate-600 hover:bg-slate-50 p-1 rounded-full transition"
            >
              <X size={24} />
            </button>
