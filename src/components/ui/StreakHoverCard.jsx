...
import { Flame, Check, CalendarDays, ChevronRight, Gift, Target, Snowflake } from "lucide-react";
          ...
          <div className="flex justify-between items-start">
            {weekData.map((day, idx) => (
              <div key={idx} className="flex flex-col items-center gap-2">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold border-2 transition-all duration-300 relative overflow-hidden
                  ${day.isActive 
