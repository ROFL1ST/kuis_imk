...
/**
 * Rich data-visualization of Sentence-BERT cosine similarity.
...
export function SBERTScoreViz({ score, referenceAnswer, studentAnswer }) {
  ...
  const zoneStyles = {
    teal:    { badge: 'bg-teal-50 text-teal-700 border-teal-200',       icon: 'text-teal-500',    ring: 'ring-teal-200',    bg: 'bg-teal-50 text-teal-700 border-teal-300' },
    emerald: { badge: 'bg-emerald-50 text-emerald-700 border-emerald-200', icon: 'text-emerald-500', ring: 'ring-emerald-200',  bg: 'bg-emerald-50 text-emerald-700 border-emerald-300' },
    amber:   { badge: 'bg-amber-50 text-amber-700 border-amber-200',    icon: 'text-amber-500',   ring: 'ring-amber-200',   bg: 'bg-amber-50 text-amber-700 border-amber-300' },
    red:     { badge: 'bg-red-50 text-red-700 border-red-200',          icon: 'text-red-500',     ring: 'ring-red-200',     bg: 'bg-red-50 text-red-700 border-red-300' },
  };
  ...
  return (
    <div className="card p-5 space-y-5 animate-fade-up">
      ...
      <div className="flex items-end gap-4">
        <div className={cn(
          'flex items-center justify-center w-20 h-20 rounded-2xl border-2 font-mono font-semibold tabular text-2xl ring-4',
          st.ring, st.bg
        )}>
          {score.toFixed(2)}
        </div>
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-2xs text-ghost tabular">
          <span>0.0</span><span>0.40</span><span>0.65</span><span>0.85</span><span>1.0</span>
        </div>
