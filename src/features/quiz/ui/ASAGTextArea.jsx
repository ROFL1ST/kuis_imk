...
/**
 * Premium ASAG short-answer textarea.
 * Receives all state/handlers as props — purely presentational.
 *
 * Props:
 *   value, onChange, wordCount, charCount, charsRemaining,
 *   validation, questionNumber, totalQuestions, disabled
 */
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3 text-xs tabular text-ghost">
            <span>
              <span className={cn(wordCount > 0 ? 'text-sub' : '')}>
                {wordCount}
              </span>{' '}
              words
            </span>
